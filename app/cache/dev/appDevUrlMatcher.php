...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // MyApp_CrediWire_homepage
        if ($pathinfo === '/login') {
            return array (  '_controller' => 'MyApp\\CrediWireBundle\\Controller\\DefaultController::indexAction',  '_route' => 'MyApp_CrediWire_homepage',);
        }

        // MyApp_CrediWire_signup
        if ($pathinfo === '/signup') {
            return array (  '_controller' => 'MyApp\\CrediWireBundle\\Controller\\DefaultController::signupAction',  '_route' => 'MyApp_CrediWire_signup',);
        }

        // MyApp_CrediWire_logout
        if ($pathinfo === '/logout') {
            return array (  '_controller' => 'MyApp\\CrediWireBundle\\Controller\\DefaultController::logoutAction',  '_route' => 'MyApp_CrediWire_logout',);
        }

        // MyApp_CrediWire_add
        if ($pathinfo === '/project') {
            return array (  '_controller' => 'MyApp\\CrediWireBundle\\Controller\\ProjectController::indexAction',  '_route' => 'MyApp_CrediWire_add',);
        }
        ...
        // project_new
        if (preg_match('#^/(?P<id>[^/]++)/newp$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'project_new')), array (  '_controller' => 'MyApp\\CrediWireBundle\\Controller\\ProjectController::newAction',));
        }
        ...
        if (preg_match('#^/(?P<id>[^/]++)/new$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'logonhistory_new')), array (  '_controller' => 'MyApp\\CrediWireBundle\\Controller\\LogonHistoryController::logAction',));
        }
        ...
        // logonhistory_edit
        if (preg_match('#^/(?P<id>[^/]++)/editlog$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'logonhistory_edit')), array (  '_controller' => 'MyApp\\CrediWireBundle\\Controller\\LogonHistoryController::outAction',));
        }
